...
const OrderRow = ({ index, order, setDeleteItem }) => {
    ...
    return (
        <tr>
            ...
            <td>{!order.paid ? <label onClick={() => setDeleteItem(order)} htmlFor="my-modal" className="btn btn-xs modal-button">Cancel</label> : <span>Can't Cancel after payment</span>}</td>
