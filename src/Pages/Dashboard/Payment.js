...
const Payment = () => {
    const { id } = useParams();
    const { data: order, isLoading } = useQuery(['orders', id], () => fetch(`https://dry-headland-80440.herokuapp.com/orders/${id}`, {
        method: 'GET',
        headers: {
    ...
    return (
        <div>
            <div className='pt-10'>
                <h1 className="text-4xl text-center font-bold text-primary ">Make your payment here</h1>
