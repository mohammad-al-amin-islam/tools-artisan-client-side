...
const AddTools = () => {
    ...
    return (
        <div>
            <div>
                <div className='pt-10'>
                    <h1 className="text-4xl text-left font-bold text-primary ">Add a Tools</h1>
                    ...
                    <div class="card-body">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className="form-control w-full">
                                ...
                                />
                                <label className="label">
                                    {errors.price?.type === 'required' && <p>{errors.price.message}</p>}
                                </label>
                            </div>
                            <div className="form-control w-full">
                                <label className="label">
                            ...
                            <div className="form-control w-full">
                                ...
                                />
                                <label className="label">
                                    {errors.minOrder?.type === 'required' && <p>{errors.minOrder.message}</p>}
                                </label>
                            </div>
                            <div className="form-control w-full">
                                <label className="label">
                                ...
                                />
                                <label className="label">
                                    {errors.availableQuantity?.type === 'required' && <p>{errors.availableQuantity.message}</p>}
                                </label>
                            </div>
                            ...
                            <input className='btn btn-primary w-full' type="submit" value='Add Tools' />
                        </form>
                    </div>
                </div>
            </div>
